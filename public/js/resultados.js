    ...
    "sim-boxer-2025": {
      ...
      tabs: {
        "boxer-porsche": {
          ...
          data: [
            { pos: 1, name: "Gabriel Parra", points: 0 },
            { pos: 2, name: "Eduardo Socarras", points: 0 },
            { pos: 3, name: "Ricardo Serrano", points: 0 },
            { pos: 4, name: "Carlos Alvarez", points: 0 },
            { pos: 5, name: "Pablo Granadillo", points: 0 },
            { pos: 6, name: "Luis Ramírez", points: 0 },
            { pos: 7, name: "Paul Ordoñez", points: 0 },
            { pos: 8, name: "Jesus Zabala", points: 0 },
            { pos: 9, name: "Jhoiner Cornelis", points: 0 },
            { pos: 10, name: "José Ruiz", points: 0 },
            { pos: 11, name: "Luis González", points: 0 },
            { pos: 12, name: "Andrés Aza", points: 0 },
            { pos: 13, name: "Victor Cova", points: 0 },
            { pos: 14, name: "Carlos Aleman", points: 0 },
            { pos: 15, name: "Hector García", points: 0 },
          ],
        },
        "boxer-toyota": {
          ...
          headers: ["Pos", "Piloto", "Puntos"],
          data: [
            { pos: 1, name: "Luis Monasterios", points: 0 },
            { pos: 2, name: "Erick Ramírez", points: 0 },
            { pos: 3, name: "Gabriel Medina", points: 0 },
            { pos: 4, name: "Felix Vargas", points: 0 },
            { pos: 5, name: "Elionay Delgado", points: 0 },
            { pos: 6, name: "Kevin Prada", points: 0 },
            { pos: 7, name: "Hugo De Sousa", points: 0 },
            { pos: 8, name: "Carlos Reyes", points: 0 },
            { pos: 9, name: "Luis Millán", points: 0 },
            { pos: 10, name: "Pablo Ricupero", points: 0 },
            { pos: 11, name: "Cesar Acevedo", points: 0 },
            { pos: 12, name: "José Pernía", points: 0 },
            { pos: 13, name: "Andrés Gutiérrez", points: 0 },
            { pos: 14, name: "Juan Sanz", points: 0 },
            { pos: 15, name: "Castor Morales", points: 0 },
            { pos: 16, name: "Ranses Gutiérrez", points: 0 },
